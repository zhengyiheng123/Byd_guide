...
public class GetedFragment_Finished extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ListView lv_common;

    private List<MyDemandBean.DemandsBean> mList=new ArrayList<>();
    private BaseArrayAdapter adapter;

    public static GetedFragment_Finished instance;
    ...
    public int getResource() {
        return R.layout.fragment_geted_finished;
    }
...
//                订单状态 -2|发布者取消 -1|接受者取消 0|待接单 1|已被接单 2|已完成 3|已评价
    ...
    public void getNetData(){
        ...
        Observable<HttpResult<MyDemandBean>> result= ServiceApi.getInstance().getServiceContract().getMyDemanOther("2",apitoken);
