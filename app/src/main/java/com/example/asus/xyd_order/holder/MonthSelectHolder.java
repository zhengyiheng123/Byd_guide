...
public class MonthSelectHolder extends BaseViewHolder<YearAndMonth>{
    ...
    @Override
    public void onBindViewHolder(Context context, YearAndMonth calendarBean) {
        tv_title.setText(calendarBean.getMonth());
    }

    @Override
    public int getLayoutId() {
        return R.layout.item_months_select;
    }
}
