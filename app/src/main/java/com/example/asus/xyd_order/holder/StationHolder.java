...
public class StationHolder extends BaseViewHolder<RouteResult.StationsBean> {
    ...
    @Override
    public void onBindViewHolder(Context context, RouteResult.StationsBean routesBean) {
        tv_station.setTextColor(context.getResources().getColor(R.color.material_grey_700));
        tv_station.setText(routesBean.getStation_name());
    }
